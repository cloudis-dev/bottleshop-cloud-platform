...
class Environment {
  static bool get crashlyticsEnabled => kIsWeb
      ? false
      : kDebugMode
          ? const bool.fromEnvironment('crashlytics_enabled', defaultValue: false)
          : true;
  static bool get analyticsEnabled =>
      kDebugMode ? const bool.fromEnvironment('analytics_enabled', defaultValue: false) : true;
  static bool get fbEmulatorsEnabled =>
      kDebugMode ? const bool.fromEnvironment('emulators_enabled', defaultValue: true) : false;
  static String get appleSignInClientId => dotenv.env['APPLE_SIGNIN_CLIENT_ID'] ?? 'n/a';
  static String get applePayMerchantId => dotenv.env['APPLE_PAY_MID'] ?? 'n/a';
  static String get tcsPdfUrl => dotenv.env['TCS_PDF_URL'] ?? 'n/a';
  static String get appleSignInRedirect => dotenv.env['APPLE_SIGN_IN_REDIRECT'] ?? 'n/a';
  ...
  static String get stripeDeepLink => dotenv.env['STRIPE_DEEPLINK_SCHEME'] ?? 'flutterstripe';
