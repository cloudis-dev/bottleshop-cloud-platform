...
class ItemsState<T> {
  ...
  bool get isDoneAndEmpty => status == ItemsStateStatus.allLoaded && items.isEmpty;

  @override
  bool operator ==(other) =>
      other is ItemsState<T> && const DeepCollectionEquality.equals(other.items, items) && other.status == status;

  @override
  int get hashCode => const DeepCollectionEquality.hash(items) ^ status.hashCode;
