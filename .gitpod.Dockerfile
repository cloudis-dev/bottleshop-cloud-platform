...
RUN cd /home/gitpod && \
  ...
  https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2021.1.1.23/android-studio-2021.1.1.23-linux.tar.gz && \
...
ENV PATH "$PATH:$HOME/Android/sdk/cmdline-tools/latest"